# ANSUR II ↔ Sammy MEAS Mapping · v0.8.20.1
...
## v0.8.20.1 audit-locked geometry

- **Trapezius Point:** same geometric point as the corresponding Neck lateral landmark; independent Trapezius offsets are retired.
- **Cervicale:** the residual correction from the 2026-08-23 audit is promoted into the canonical MEAS landmark.
- **Buttock lateral / Hip Breadth:** one source of truth: the left/right extrema of the Buttock-Circumference slice are both the Buttock-lateral landmarks and the Hip-Breadth endpoints.
- **Shoulder Length:** Harness-Lab projection: straight Neck-lateral/Trapezius→Acromion guide, subdivided into 34 samples; each sample searches the skin bidirectionally at 90° to the guide.
- **Waist Back Length:** ANSUR numeric target remains the documented surface/tape distance. PROT deliberately displays a straight off-body vertical guide ending at Cervicale height, so the visual audit is clean without redefining the statistical ANSUR variable.
