// Sammy v0.8.24.12 · lazy MORF limb section engine.
// Pure geometry module: no DOM, no THREE, no solver/UI side effects.
...
export function computeLimbProfiles({rest,triangles,regionMap}){
